...
#### Database connections for `msdocs-flask-postgresql-sample-app`

The following environment variables are set for `msdocs-flask-postgresql-sample-app` in [resources.bicep](./infra/resources.bicep).
...
- Azure Container App to host the 'msdocs-flask-postgresql-sample-app' service.
- Azure Postgres Flexible Server to host the 'Outdoors' database.
